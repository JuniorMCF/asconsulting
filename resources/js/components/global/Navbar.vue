<template>
    <div class="header-nav">
        <v-app-bar color="transparent" light class="elevation-0 pa-0 app-bar_container" height="87">
        ...
        >
            ...
            <v-list>
                <v-list-item
                    ...
                    :to="item.route"
                >
                    <v-list-item-title class="caption white--text font-weight-bold">{{ item.title }}</v-list-item-title>
                </v-list-item>
                <v-list-group
                    v-for="item in items_group"
                    :key="item.title"
                    active-class="success  primary--text"
                    v-model="item.active"
                >
