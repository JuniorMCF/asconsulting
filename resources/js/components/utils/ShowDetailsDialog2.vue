        ...
        <v-container class="pa-0 ma-0">
          <v-row class="pa-0 ma-0">
            ...
            >
              ...
              <v-card-text>
                   <p class="text-center mx-auto text-h5 mb-0">BENEFICIOS</p>
              </v-card-text>
              
          
              <span
                v-for="(text, i) in beneficios"
                :key="'benef' + i"
                class="line-height_1"
              >
                <ul class="subtitle-1 py-0 pl-4">
            ...
            <v-col
              ...
              "
            >
             <p class="text-center mx-auto text-h5">INCLUYE</p>
              <span v-for="(text, i) in incluye" :key="'incluye' + i" class="line-height_1">
                <ul class="subtitle-1 py-0 pl-4">
                  <li  class="line-height_1_3">
...
export default {
  ...
  methods: {
    open(object, categoria, options) {
      ...
      this.categoria =
        "mailto:reactivatunegocio@asconsulting.pe?subject=" +
        categoria +
        " / " +
        object.titulo;
