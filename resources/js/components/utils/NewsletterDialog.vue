        ...
        <v-card class="bg-newsletter pa-4">
            ...
            <v-card-text class="text-center">
                ...
                <div class="d-flex flex-wrap justify-center align-center my-4">
                    <v-text-field dense class="rounded-0 white" v-model="correo" placeholder="Ingresa tu email"  style="max-width:400px;" outlined hide-details="auto" ></v-text-field>
                    <v-btn
                        color="primary"

                        class="body-2 font-weight-bold text-normal rounded-0 white--text elevation-0"
                        height="40"
                        @click.native="agree"
                    >Enviar</v-btn>
                </div>
