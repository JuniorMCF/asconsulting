<template>
    <div>
        <v-container fluid class="content-wrap pa-0 mx-auto py-16">
            ...
            <v-row class="pa-0 ma-0 content-wrap-0 mx-auto align-center my-16">
                ...
                <v-col class="col-12 col-md-6 text-center text-md-left my-4">
                    ...
                    <p class="black--text text-justify as-p_normal ma-0">
                        ...
                        <strong>nuestra experiencia en el sector</strong>,
            ...
            <v-row class="pa-0 ma-0 content-wrap-0 mx-auto align-center">
                <v-card
                    class="col-12 primary pa-2 rounded-0 elevation-1"
                ></v-card>
            </v-row>
            <v-row class="pa-0 ma-0 content-wrap-0 mx-auto align-center">
                <v-col class="col-12 col-md-6 pa-0">
                    <v-card class="card-grey elevation-0 rounded-0">
                        <v-card-text class="pa-15 card-grey">
                            <div class="mx-auto">
                                <div
                                    class="mx-auto container-mision_visionLogo"
                                >
                                    <v-img src="/app/mision_logo.png"></v-img>
                                </div>
                            </div>
                            <div
                                class="mx-auto primary--text text-center py-3 my-2"
                            >
                                <span
                                    class="title-letter_space1 as-text_medium font-weight-bold"
                                    >MISIÓN</span
                                >
                            </div>
                            <div class="mx-auto text-center">
                                <span
                                    class="as-p_normal line-height_2 primary--text"
                                >
            ...
            <!--line primary-->
            <v-row
                class="pa-0 ma-0 content-wrap-0 mx-auto align-center mb-10 pb-16"
            >
                <v-card
                    class="col-12 primary pa-2 rounded-0 elevation-1"
                ></v-card>
