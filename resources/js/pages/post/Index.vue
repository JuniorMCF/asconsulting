<template>
    <div>
        <v-container class="content-wrap-2 pa-0 mx-auto my-16">
            <v-row class="pa-0 ma-0 content-wrap-0 mx-auto elevation-0 pt-md-15">
                <v-col
                    class="col-12 col-md-12 py-0 px-md-2 px-0"
            ...
            >
                <v-col
                    class="col-12 ma-0 pa-4 px-md-16 d-flex flex-wrap align-center"
                >
            ...
            >
                ...
                >
                    <v-card-text class="pa-0">
                        ...
                        <div
                            class="ql-editor pa-0 py-6"
                            v-html="this.post.contenido"
                        ></div>
            ...
            >
                ...
                >
                    <span class="mr-2 black--text"
                        >{{ post.visualizaciones.length }} visualizaciones</span
                    >
                    <span class="black--text"
                        >{{ post.comments.length }} comentarios</span
                    >
                    <v-spacer></v-spacer>
                    <span fab small class="black--text">
            ...
            <!--comentarios-->
            <v-row
                class="pa-0 ma-0 content-wrap-article mx-auto elevation-0 pb-16"
                v-if="!loadingFilterPosts"
            >
                <v-col class="col-12 mt-3 pa-4 px-md-16">
                    <v-card-text class="pa-0 align-center d-flex flex-wrap">
                        <span class="black--text title">Comentarios</span>
                    </v-card-text>
    			...
    			c0-0.3,0.1-0.6,0.1-0.9c0-0.2,0.1-0.4,0.1-0.6c0-0.3,0.1-0.7,0.1-1c0-0.2,0-0.3,0-0.5c0-0.5,0-1,0-1.5C60,13.4,46.6,0,30,0z
    			 M30.7,33.9c-6.4,0-11.5-5.2-11.5-11.6c0-6.4,5.2-11.6,11.5-11.6s11.5,5.2,11.5,11.6C42.3,28.7,37.1,33.9,30.7,33.9z"
                    ...
                    >
                        ...
                        ></v-text-field>
                        <v-card-text
                            class="py-0 d-flex flex-wrap space-between"
                            v-show="isComment"
                        >
                            <div>
                                <v-btn
...
export default {
    ...
    methods: {
        ...
        onHandleClickVEPicker(event) {
            const vepicker = document.getElementById("vpicker");
            const btnvpicker = document.getElementById("btnvpicker");
            const outsideClickVEpicker =
                    typeof event.composedPath === "function" &&
                    !event.composedPath().includes(vepicker);

            const insideClickBtnVEPicker = typeof event.composedPath === "function" &&
                    !event.composedPath().includes(btnvpicker);
