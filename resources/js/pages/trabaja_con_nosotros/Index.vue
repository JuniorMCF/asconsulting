<template>
    <div>
        <v-container fluid class="pa-0 mx-auto py-16">
            ...
            >
                <v-col
                    class="col-12 col-md-10 d-flex align-center justify-md-start justify-center pb-10"
                >
                    <div class="text-md-start text-center">
                        <span class="as-p_normal black--text">
                            Únete a la
            ...
            if (
                ...
                axios({
                    ...
                    .then((res) => {
                        ...
                        if (res.status == 200) {
                            Vue.$toast.success(
                                "Registro exitoso!, le enviaremos un correo de confirmación"
                            );
                            this.form = {
                                nombres: "",
                                apellidos: "",
                            ...
                            Vue.$toast.info(
                                "Ya existe un trabajador con este correo"
                            );
