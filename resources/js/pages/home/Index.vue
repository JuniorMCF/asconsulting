                        ...
                        <template v-slot:caption>
                            <flux-caption v-slot="captionProps">
                                <div class="flux-content">
                                    ...
                                    ></v-img>
                                    <div v-if="captionProps.text.title != null" class="pa-0 ma-0">
                                        <div class="content-desc-title mx-auto">
                                            <span
                                                v-for="(element, i) in captionProps.text.title"
                                                :key="i"
                                            >
                                                <p
                                    ...
                                    <p
                                        v-if="captionProps.text.subtitle_image != null"
                                        class="pa-0 ma-0"
                                    >
                                    ...
                                    <div
                                        v-if="captionProps.text.subtitle != null"
                                        class="pa-0 ma-0 my-5"
                                    >
                                        <div class="content-desc-subtitle mx-auto">
                                            <span
                                                v-for="(element, i) in captionProps.text.subtitle"
                                                :key="i"
                                            >
                                                <span
                                                ...
                                                <strong
                                                    class="as-text_normal"
                                                    v-else-if="element.type == 'strong'"
                                                >{{ element.text }}</strong>
                                                <p class="as-text_normal ma-0" v-else>
                                                    <span>{{ element.text }}</span>
                                                </p>
                                            </span>
                                        </div>
                                    </div>
                                    <div v-if="captionProps.text.actions != null">
                                        <div
                                            class="content-desc-title mx-auto d-flex justify-space-between my-6"
                                        >
                                            <span
                                                v-for="(action, i) in captionProps.text.actions"
                                                :key="i"
                                                class="mx-auto"
                                            >
                                                <v-hover v-slot="{ hover }">
                                                    <v-btn
                                                        :class="{ 'primary--text white': hover }"
                                                        outlined
                                                        color="white"
                                ...
                                <div class="mt-12">
                                    <v-btn fab outlined color="white" href="#ayudanos">
                                        <v-icon class="white--text" large>mdi-chevron-down</v-icon>
                                    </v-btn>
                                </div>
                            </flux-caption>
                        </template>
        ...
        <v-container fluid class="pa-0 ma-0 main-content">
            ...
            >
                <v-col class="col-10 col-xs-6 col-md-5 pa-5">
                    ...
                    <v-card class="rounded-0 elevation-2 container-card mx-auto">
                        <v-card-text class="pa-6 text-line-card text-center">
                            <span class="as-title_large alternative--text">
                                Ayudamos a
                                <strong>cumplir los objetivos</strong> de nuestros
                                clientes,
            ...
            <v-row class="ma-0 my-5 pa-0 d-flex justify-center content-wrap-2 mx-auto">
                <v-col
                ...
                >
                    ...
                    <v-card class="elevation-0 d-flex align-center px-4">
                        <div class="d-block">
                            <span class="as-text_extraLarge primary--text">¿Qué nos</span>
                            <br />
                            <span
                ...
                <v-col class="col-12 col-md-6 pa-5">
                    <ul>
                        ...
                        <li class="as-li_normal primary--text">Visión estratégica.</li>
                        <li class="as-li_normal primary--text">Metodología ágil y colaborativa.</li>
                        <li class="as-li_normal primary--text">Conocimiento del mercado.</li>
                        <li
                            class="as-li_normal primary--text"
                        >Enfoque digital y de experiencia al usuario (UX).</li>
                    </ul>
                </v-col>
            </v-row>
            ...
            <v-row class="pa-0 ma-0 primary content-wrap-2 mx-auto">
                <v-col class="col-12 pa-0">
                    <v-card-text class="text-uppercase white--text text-center">
                        ...
                        <br />
                        <span class="as-text_extraLarge pl-16 font-weight-bold">Servicios</span>
                    </v-card-text>
                </v-col>
            </v-row>
            ...
            <v-row class="pa-0 ma-0 content-wrap-2 mx-auto">
                <v-col class="col-12 pa-0 ma-0">
                    ...
                    >
                        ...
                        <template v-slot:caption>
                            <flux-caption v-slot="captionProps" style="position:absolute; top:10%">
                                <p
                                    class="white--text as-text_extraLarge mb-0 font-weight-bold mx-auto"
                                    style="width:350px;line-height:1"
                                >{{ captionProps.text.title }}</p>
                                <p
                                    class="white--text as-text_normal my-4"
                                >{{ captionProps.text.subtitle }}</p>
                                <ul class="white--text text-start mx-auto" style="max-width:350px">
                                    <li
                                        class="white--text text-subtitle-1"
                                        v-for="(element, i) in captionProps.text.detalles"
                                        :key="'data' + i"
                                    >{{ element }}</li>
                                </ul>
                                <v-hover v-slot="{ hover }">
            ...
            <v-row class="pa-0 ma-0 content-wrap-2 mx-auto">
                <v-col class="col-12 col-md-5 d-flex align-center justify-md-end justify-center">
                    <div class="d-block">
                        <span class="as-text_extraLarge primary--text">Solicita tu</span>
                        <br />
                        <span
                            class="as-text_extraLarge pl-7 font-weight-bold text-uppercase primary--text"
                        >asesoría</span>
    ...
    methods: {
        ...
        sendRequest() {
            ...
            if (this.form.nombres != '' && this.form.email != '' && this.form.telefono != '' && this.form.servicio != '' && this.form.comentario != '') {
                ...
                axios.post("/api/asesoria", this.form).then(res => {
