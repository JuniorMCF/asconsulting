<template>
    <div>
        <v-container fluid class=" pa-0 mx-auto py-16">
            ...
            <v-row
                class="pa-0 ma-0 content-wrap-0 mx-auto align-center my-md-15"
            >
                ...
                <v-col class="col-12 col-md-6 text-center text-md-left my-4">
                    <p
                        class="black--text text-center text-md-justify as-p_normal ma-0"
                    >
            ...
            >
                ...
                >
                    <v-card
                        class="rounded-0 elevation-0  d-flex flex-md-row flex-column align-center justify-center"
                        style="height: 450px"
                    >
