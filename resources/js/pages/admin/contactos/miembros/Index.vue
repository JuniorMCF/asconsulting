            ...
            <v-row class="pa-0 ma-0">
                <v-col class="pa-0 ma-0 col-12">
                    <v-card-text class="px-0 py-0">
                        <p
                            class="caption ma-0"
                        >Los miembros son personas que se registraron en tu sitio. Mira y administra los miembros de tu sitio aquí.</p>
                    </v-card-text>
                </v-col>
            </v-row>
        </v-container>
                ...
                <v-col class="col-12 pa-0 ma-0">
                    ...
                    >
                        ...
                        <template v-slot:item.last_session="{ item }">
                            <span>{{ formatDate(item.last_session) }}</span>
                        </template>
...
export default {
    data: () => ({
        headers: [
            ...
            { text: "Ultimo inicio de sesión", value: "last_session" },
