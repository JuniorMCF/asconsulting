<template>
    <div>
        ...
        <v-container fluid class="pa-0 ma-0 px-md-10 px-3">
                ...
                <v-col class="col-12 col-md-8 pa-0">
                    ...
                    <v-container fluid class="pa-0 ma-0">
                        <v-row class="pa-0 ma-0">
                            <v-col class="col-12">
                                <span class="title font-weight-bold">Descripción (opcional)</span>
                            </v-col>
                            <v-col class="col-12">
                                <v-text-field
                                    color="sky"
                                    v-model="document.descripcion"
                            ...
                            <v-col class="col-12">
                                ...
                                >No hay una imagen asociada al post</span>
                            </v-col>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="border mt-3">
                                        ...
                                        <template v-if="isPreview">
                                            <v-img :src="image" height="500" contain alt="preview"></v-img>
                                        </template>
                                    </div>
                                </div>
                            </v-col>
            ...
            <v-row class="justify-center pa-0 ma-0">
                <v-col class="col-12 col-md-8">
                    <span class="title font-weight-bold">Adjuntar PDF (opcional)</span>
                </v-col>
                <v-col class="col-12 col-md-8">
                        ...
                        <div class="pa-4">
                            <div class="d-flex flex-wrap justify-center align-center mb-4">
                                ...
                                <v-btn
                                    large
                                    color="sky"
                                    class="rounded-0 my-2 text-normal white--text caption elevation-0 px-16"
                                    :loading="loadingTag"
