    ...
    <div>
        <v-container fluid class="pa-0 ma-0 px-md-10 px-3">
            ...
            <v-row class="pa-0 ma-0 justify-center">
                <v-col class="pa-0 ma-0 col-12 col-md-6 mb-4">
                    <span class="text-h4 black--text font-weight-bold">{{ categoria.nombre }}</span>
                </v-col>
            </v-row>
            <v-row class="pa-0 ma-0 justify-center">
            ...
            <v-row class="pa-0 ma-0 justify-center">
                <v-col class="py-4 ma-0 col-6 col-md-3 pl-0">
                    <v-btn :loading="loadSave" class="text-normal elevation-0 white--text rounded-lg" color="sky" block
                        @click.prevent="saveCategory()" v-if="role.slug == 'propietario'">Guardar</v-btn>
                </v-col>
