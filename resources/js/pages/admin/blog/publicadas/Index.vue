...
export default {
    ...
    methods: {
        ...
        trashAll() {
            this.$refs.confirmDialog.open("Eliminar todos", "¿Está seguro que quiere mover a papelera todos los posts seleccionados?").then((res) => {
                if (res) {
                    let data = new FormData()
    ...
    components: { DialogArticle, SharedDialog, ConfirmDialog }
}
</script>
