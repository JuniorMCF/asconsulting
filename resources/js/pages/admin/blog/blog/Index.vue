            ...
            <v-row class="pa-0 ma-0">
                <v-col class="pa-0 ma-0">
                    <v-card-text class="px-0">
                        <span
                            class="title font-weight-bold subtitle-1"
                    ...
                    >
                        ...
                        <template v-slot:top>
                            <v-card-text flat class="px-0 d-flex flex-wrap">
                                <v-toolbar-title
                                    class="px-0 subtitle-1 font-weight-bold"
                                ...
                                <v-btn
                                    text
                                    color="sky"
                                    class="text-normal caption"
                                    @click.prevent="goToInformes()"
                                >
                                    <v-icon color="sky" left small>mdi-chart-bar</v-icon>todos los informes del blog
                                </v-btn>
                                <v-divider class="mx-4 pa-0 d-none d-md-block"  vertical></v-divider>
                                <v-btn
                                    @click.prevent="goToPublicadas()"
                                    text
                                    color="sky"
                                    class="text-normal caption"
